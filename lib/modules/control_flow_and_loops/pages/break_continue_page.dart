...
import '../controllers/break_continue_controller.dart';

class BreakContinuePage extends GetView<BreakContinueController> {
  const BreakContinuePage({super.key});
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
            ...
            slivers: [
              if (!AS.deviceScreenType.isMobile)
                SliverAppBar(
                  ...
                  pinned: true,
                  flexibleSpace:
                      PageHeader(headerName: SK.breakAnndContinue),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const CommonHeight(height: 8),
                      CodeWidget(code: controller.breakCode),
                      const CommonHeight(height: 8),
                      CodeWidget(code: controller.breakOutput),
                      const CommonHeight(height: 20),
                      BigText(
                        text: controller.continueTitle,
                        style: AppStyle.globalBigTextStyle.copyWith(
                          fontSize: 22,
                          fontWeight: FontWeight.bold,
                        ),
                      ...
                      const CommonHeight(height: 8),
                      CodeWidget(code: controller.continueCode),
                      const CommonHeight(height: 8),
                      CodeWidget(
                          code: controller.continueOutput),
                      const CommonHeight(height: 20),
                      BigText(
                        text: controller.searchTitle,
                        style: AppStyle.globalBigTextStyle.copyWith(
                          fontSize: 22,
                          fontWeight: FontWeight.bold,
                        ),
                      ...
                      const CommonHeight(height: 8),
                      CodeWidget(code: controller.searchCode),
                      const CommonHeight(height: 8),
                      CodeWidget(code: controller.searchOutput),
                      const CommonHeight(height: 20),
                      BigText(
                        text: 'Tips',
                        style: AppStyle.globalBigTextStyle.copyWith(
          ...
          GetBuilder<BreakContinueController>(
            builder: (_) {
