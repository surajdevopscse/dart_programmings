...
import '../controllers/assert_controller.dart';

class AssertPage extends GetView<AssertController> {
  const AssertPage({super.key});
            ...
            slivers: [
              if (!AS.deviceScreenType.isMobile)
                SliverAppBar(
                  ...
                  floating: false,
                  pinned: true,
                  flexibleSpace: PageHeader(headerName: SK.assertInDart),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const CommonHeight(height: 20),
                      BigText(
                        text: controller.withMessageTitle,
                        style: AppStyle.globalBigTextStyle.copyWith(
                          fontSize: 22,
                          fontWeight: FontWeight.bold,
                        ),
                      ...
                      const CommonHeight(height: 8),
                      BigText(
                        text: controller.withMessageDesc,
                        style: AppStyle.globalSmallTextStyle.copyWith(
                          fontSize: 16,
                          fontWeight: FontWeight.normal,
                        ),
                      ...
                      const CommonHeight(height: 8),
                      CodeWidget(code: controller.withMessageCode),
                      const CommonHeight(height: 8),
                      CodeWidget(
                          code: controller.withMessageOutput),
                      const CommonHeight(height: 20),
                      BigText(
                        text: controller.functionAssertTitle,
                        style: AppStyle.globalBigTextStyle.copyWith(
                          fontSize: 22,
                          fontWeight: FontWeight.bold,
                        ),
                      ...
                      const CommonHeight(height: 8),
                      BigText(
                        text: controller.functionAssertDesc,
                        style: AppStyle.globalSmallTextStyle.copyWith(
                          fontSize: 16,
                          fontWeight: FontWeight.normal,
                        ),
                      ...
                      const CommonHeight(height: 8),
                      CodeWidget(code: controller.functionAssertCode),
                      const CommonHeight(height: 8),
                      CodeWidget(
                          code: controller.functionAssertOutput),
                      const CommonHeight(height: 20),
                      BigText(
                        text: 'Tips',
                        style: AppStyle.globalBigTextStyle.copyWith(
                      ...
                      PreviousNextButton(
                        back: () =>
                            AppPages.router.go(AppPath.CONDITIONS),
