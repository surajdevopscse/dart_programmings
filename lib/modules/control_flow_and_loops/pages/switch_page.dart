...
class SwitchPage extends GetView<SwitchController> {
            ...
            slivers: [
              if (!AS.deviceScreenType.isMobile)
                SliverAppBar(
                  ...
                  floating: false,
                  pinned: true,
                  flexibleSpace: PageHeader(headerName: SK.switchCase),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const CommonHeight(height: 20),
                      BigText(
                        text: controller.basicSwitchTitle,
                        style: AppStyle.globalBigTextStyle.copyWith(
                          fontSize: 22,
                      ...
                      BigText(
                        text: controller.basicSwitchDesc,
                        style: AppStyle.globalSmallTextStyle.copyWith(
                          fontSize: 16,
                          fontWeight: FontWeight.normal,
                        ),
                      ...
                      const CommonHeight(height: 8),
                      CodeWidget(code: controller.basicSwitchCode),
                      const CommonHeight(height: 8),
                      CodeWidget(
                          code: controller.basicSwitchOutput),
                      const CommonHeight(height: 20),
                      BigText(
                        text: controller.intSwitchTitle,
                        style: AppStyle.globalBigTextStyle.copyWith(
                          fontSize: 22,
                          fontWeight: FontWeight.bold,
                        ),
                      ...
                      const CommonHeight(height: 8),
                      CodeWidget(code: controller.intSwitchCode),
                      const CommonHeight(height: 8),
                      CodeWidget(
                          code: controller.intSwitchOutput),
                      const CommonHeight(height: 20),
                      BigText(
                        text: controller.fallThroughTitle,
                        style: AppStyle.globalBigTextStyle.copyWith(
                          fontSize: 22,
                          fontWeight: FontWeight.bold,
                        ),
                      ...
                      const CommonHeight(height: 8),
                      BigText(
                        text: controller.fallThroughDesc,
                        style: AppStyle.globalSmallTextStyle.copyWith(
                          fontSize: 16,
                          fontWeight: FontWeight.normal,
                        ),
                      ...
                      const CommonHeight(height: 8),
                      CodeWidget(code: controller.fallThroughCode),
                      const CommonHeight(height: 8),
                      CodeWidget(
                          code: controller.fallThroughOutput),
                      const CommonHeight(height: 20),
                      BigText(
                        text: 'Tips',
                        style: AppStyle.globalBigTextStyle.copyWith(
                      ...
                      PreviousNextButton(
                        ...
                        next: () => AppPages.router
                            .go('${AppPath.CONDITIONS}/${AppPath.TERNERY}'),
                        isEnableBack: true,
                        isEnableNext: true,
                      ),
