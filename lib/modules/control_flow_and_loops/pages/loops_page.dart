...
class LoopsPage extends GetView<LoopsController> {
            ...
            slivers: [
              if (!AS.deviceScreenType.isMobile)
                SliverAppBar(
                  ...
                  floating: false,
                  pinned: true,
                  flexibleSpace: PageHeader(headerName: SK.loops),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const CommonHeight(height: 20),
                      BigText(
                        text: controller.loopTypesTitle,
                        style: AppStyle.globalBigTextStyle.copyWith(
                          fontSize: 22,
                          fontWeight: FontWeight.bold,
                        ),
                      ...
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: controller.loopTypes
                            .map((type) => SmallText(
                                  text: '${AppConstant.getBullet()} $type',
                      ...
                      const CommonHeight(height: 8),
                      CodeWidget(code: controller.overviewCode),
                      const CommonHeight(height: 8),
                      CodeWidget(
                          code: controller.overviewOutput),
                      const CommonHeight(height: 20),
                      BigText(
                        text: 'Tips',
                        style: AppStyle.globalBigTextStyle.copyWith(
