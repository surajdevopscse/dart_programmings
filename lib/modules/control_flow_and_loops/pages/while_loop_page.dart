...
import '../controllers/while_loop_controller.dart';

class WhileLoopPage extends GetView<WhileLoopController> {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
            ...
            slivers: [
              if (!AS.deviceScreenType.isMobile)
                SliverAppBar(
                  ...
                  floating: false,
                  pinned: true,
                  flexibleSpace: PageHeader(headerName: SK.whileLoop),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const CommonHeight(height: 20),
                      BigText(
                        text: controller.basicWhileTitle,
                        style: AppStyle.globalBigTextStyle.copyWith(
                          fontSize: 22,
                      ...
                      BigText(
                        text: controller.basicWhileDesc,
                        style: AppStyle.globalSmallTextStyle.copyWith(
                          fontSize: 16,
                          fontWeight: FontWeight.normal,
                        ),
                      ...
                      const CommonHeight(height: 8),
                      CodeWidget(code: controller.basicWhileCode),
                      const CommonHeight(height: 8),
                      CodeWidget(
                          code: controller.basicWhileOutput),
                      const CommonHeight(height: 20),
                      BigText(
                        text: controller.countdownTitle,
                        style: AppStyle.globalBigTextStyle.copyWith(
                          fontSize: 22,
                          fontWeight: FontWeight.bold,
                        ),
                      ...
                      const CommonHeight(height: 8),
                      CodeWidget(code: controller.countdownCode),
                      const CommonHeight(height: 8),
                      CodeWidget(
                          code: controller.countdownOutput),
                      const CommonHeight(height: 20),
                      BigText(
                        text: controller.userInputTitle,
                        style: AppStyle.globalBigTextStyle.copyWith(
                          fontSize: 22,
                          fontWeight: FontWeight.bold,
                        ),
                      ...
                      const CommonHeight(height: 8),
                      CodeWidget(code: controller.userInputCode),
                      const CommonHeight(height: 8),
                      CodeWidget(
                          code: controller.userInputOutput),
                      const CommonHeight(height: 20),
                      BigText(
                        text: 'Tips',
                        style: AppStyle.globalBigTextStyle.copyWith(
                      ...
                      PreviousNextButton(
                        back: () => AppPages.router
                            .go('${AppPath.CONDITIONS}/${AppPath.FOREACHLOOP}'),
                        next: () => AppPages.router
                            .go('${AppPath.CONDITIONS}/${AppPath.DOWHILE}'),
                        isEnableBack: true,
                        isEnableNext: true,
                      ),
          ...
          GetBuilder<WhileLoopController>(
            builder: (_) {
