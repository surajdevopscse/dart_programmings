...
import '../controllers/do_while_controller.dart';

class DoWhilePage extends GetView<DoWhileController> {
            ...
            slivers: [
              if (!AS.deviceScreenType.isMobile)
                SliverAppBar(
                  ...
                  floating: false,
                  pinned: true,
                  flexibleSpace: PageHeader(headerName: SK.doWhile),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const CommonHeight(height: 20),
                      BigText(
                        text: controller.basicDoWhileTitle,
                        style: AppStyle.globalBigTextStyle.copyWith(
                          fontSize: 22,
                      ...
                      BigText(
                        text: controller.basicDoWhileDesc,
                        style: AppStyle.globalSmallTextStyle.copyWith(
                          fontSize: 16,
                          fontWeight: FontWeight.normal,
                        ),
                      ...
                      const CommonHeight(height: 8),
                      CodeWidget(code: controller.basicDoWhileCode),
                      const CommonHeight(height: 8),
                      CodeWidget(
                          code: controller.basicDoWhileOutput),
                      const CommonHeight(height: 20),
                      BigText(
                        text: controller.conditionFalseTitle,
                        style: AppStyle.globalBigTextStyle.copyWith(
                          fontSize: 22,
                          fontWeight: FontWeight.bold,
                        ),
                      ...
                      const CommonHeight(height: 8),
                      BigText(
                        text: controller.conditionFalseDesc,
                        style: AppStyle.globalSmallTextStyle.copyWith(
                          fontSize: 16,
                          fontWeight: FontWeight.normal,
                        ),
                      ...
                      const CommonHeight(height: 8),
                      CodeWidget(code: controller.conditionFalseCode),
                      const CommonHeight(height: 8),
                      CodeWidget(
                          code: controller.conditionFalseOutput),
                      const CommonHeight(height: 20),
                      BigText(
                      ...
                      const CommonHeight(height: 8),
                      CodeWidget(code: controller.menuCode),
                      const CommonHeight(height: 8),
                      CodeWidget(code: controller.menuOutput),
                      const CommonHeight(height: 20),
                      BigText(
                        text: 'Tips',
                        style: AppStyle.globalBigTextStyle.copyWith(
