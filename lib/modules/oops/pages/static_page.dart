...
class StaticPage extends GetView<StaticController> {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
            ...
            slivers: [
              if (!AS.deviceScreenType.isMobile)
                SliverAppBar(
                  ...
                  floating: false,
                  pinned: true,
                  flexibleSpace: PageHeader(headerName: SK.static),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      PreviousNextButton(
                        back: () => AppPages.router.go(AppPath.POLYMORPHISM),
                        next: () => AppPages.router.go(AppPath.SUPERINDART),
                        isEnableBack: true,
                        isEnableNext: true,
                      ),
          ...
          GetBuilder<StaticController>(builder: (_) => controller.showBackToTopButton ? Positioned(bottom: 20, right: 20, child: FloatingActionButton(backgroundColor: AppColors.primary700, onPressed: controller.scrollToTop, child: const Icon(Icons.arrow_upward, color: Colors.white))) : const SizedBox.shrink()),
        ],
      ),
    );
  }
