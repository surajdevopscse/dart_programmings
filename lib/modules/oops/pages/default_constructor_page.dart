...
import '../controllers/default_constructor_controller.dart';

class DefaultConstructorPage extends GetView<DefaultConstructorController> {
  const DefaultConstructorPage({super.key});
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
            ...
            slivers: [
              if (!AS.deviceScreenType.isMobile)
                SliverAppBar(
                  ...
                  floating: false,
                  pinned: true,
                  flexibleSpace: PageHeader(headerName: SK.defaultConstructor),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      PreviousNextButton(
                        back: () => AppPages.router.go(AppPath.CONSTRUCTOR),
                        next: () => AppPages.router.go(AppPath.PARAMETERIZEDCONSTRUCTOR),
                        isEnableBack: true,
                        isEnableNext: true,
                      ),
          ...
          GetBuilder<DefaultConstructorController>(builder: (_) => controller.showBackToTopButton ? Positioned(bottom: 20, right: 20, child: FloatingActionButton(backgroundColor: AppColors.primary700, onPressed: controller.scrollToTop, child: const Icon(Icons.arrow_upward, color: Colors.white))) : const SizedBox.shrink()),
        ],
      ),
    );
  }
