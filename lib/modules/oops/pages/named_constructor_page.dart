...
import '../controllers/named_constructor_controller.dart';

class NamedConstructorPage extends GetView<NamedConstructorController> {
  const NamedConstructorPage({super.key});
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
            ...
            slivers: [
              if (!AS.deviceScreenType.isMobile)
                SliverAppBar(
                  ...
                  floating: false,
                  pinned: true,
                  flexibleSpace: PageHeader(headerName: SK.namedConstructor),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      PreviousNextButton(
                        back: () => AppPages.router.go(AppPath.PARAMETERIZEDCONSTRUCTOR),
                        next: () => AppPages.router.go(AppPath.CONSTANTCONTRUCTOR),
                        isEnableBack: true,
                        isEnableNext: true,
                      ),
          ...
          GetBuilder<NamedConstructorController>(builder: (_) => controller.showBackToTopButton ? Positioned(bottom: 20, right: 20, child: FloatingActionButton(backgroundColor: AppColors.primary700, onPressed: controller.scrollToTop, child: const Icon(Icons.arrow_upward, color: Colors.white))) : const SizedBox.shrink()),
        ],
      ),
    );
  }
