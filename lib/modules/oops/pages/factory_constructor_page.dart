...
import '../controllers/factory_constructor_controller.dart';

class FactoryConstructorPage extends GetView<FactoryConstructorController> {
  const FactoryConstructorPage({super.key});
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
            ...
            slivers: [
              if (!AS.deviceScreenType.isMobile)
                SliverAppBar(
                  ...
                  floating: false,
                  pinned: true,
                  flexibleSpace: PageHeader(headerName: SK.factoryConstructor),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      PreviousNextButton(
                        back: () => AppPages.router.go(AppPath.CALLABLEOBJECT),
                        next: () => AppPages.router.go(AppPath.NullSAFETY),
                        isEnableBack: true,
                        isEnableNext: false,
                      ),
          ...
          GetBuilder<FactoryConstructorController>(builder: (_) => controller.showBackToTopButton ? Positioned(bottom: 20, right: 20, child: FloatingActionButton(backgroundColor: AppColors.primary700, onPressed: controller.scrollToTop, child: const Icon(Icons.arrow_upward, color: Colors.white))) : const SizedBox.shrink()),
        ],
      ),
    );
  }
