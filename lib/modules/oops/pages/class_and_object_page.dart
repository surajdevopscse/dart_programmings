...
import '../controllers/class_and_object_controller.dart';

class ClassAndObjectPage extends GetView<ClassAndObjectController> {
  const ClassAndObjectPage({super.key});
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
            ...
            slivers: [
              if (!AS.deviceScreenType.isMobile)
                SliverAppBar(
                  ...
                  floating: false,
                  pinned: true,
                  flexibleSpace: PageHeader(headerName: SK.classAndObject),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      PreviousNextButton(
                        back: () => AppPages.router.go(AppPath.OBJECTINDART),
                        next: () => AppPages.router.go(AppPath.CONSTRUCTOR),
                        isEnableBack: true,
                        isEnableNext: true,
                      ),
          ...
          GetBuilder<ClassAndObjectController>(builder: (_) => controller.showBackToTopButton ? Positioned(bottom: 20, right: 20, child: FloatingActionButton(backgroundColor: AppColors.primary700, onPressed: controller.scrollToTop, child: const Icon(Icons.arrow_upward, color: Colors.white))) : const SizedBox.shrink()),
        ],
      ),
    );
  }
