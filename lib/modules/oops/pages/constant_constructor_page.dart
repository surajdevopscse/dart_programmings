...
import '../controllers/constant_constructor_controller.dart';

class ConstantConstructorPage extends GetView<ConstantConstructorController> {
  const ConstantConstructorPage({super.key});
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
            ...
            slivers: [
              if (!AS.deviceScreenType.isMobile)
                SliverAppBar(
                  ...
                  floating: false,
                  pinned: true,
                  flexibleSpace: PageHeader(headerName: SK.constantContructor),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      PreviousNextButton(
                        back: () => AppPages.router.go(AppPath.NAMEDCONSTRUCTOR),
                        next: () => AppPages.router.go(AppPath.ENCAPSULATION),
                        isEnableBack: true,
                        isEnableNext: true,
                      ),
          ...
          GetBuilder<ConstantConstructorController>(builder: (_) => controller.showBackToTopButton ? Positioned(bottom: 20, right: 20, child: FloatingActionButton(backgroundColor: AppColors.primary700, onPressed: controller.scrollToTop, child: const Icon(Icons.arrow_upward, color: Colors.white))) : const SizedBox.shrink()),
        ],
      ),
    );
  }
