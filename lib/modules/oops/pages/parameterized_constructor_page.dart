...
import '../controllers/parameterized_constructor_controller.dart';

class ParameterizedConstructorPage extends GetView<ParameterizedConstructorController> {
  const ParameterizedConstructorPage({super.key});
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
            ...
            slivers: [
              if (!AS.deviceScreenType.isMobile)
                SliverAppBar(
                  ...
                  floating: false,
                  pinned: true,
                  flexibleSpace: PageHeader(headerName: SK.paramterizedConstructor),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      PreviousNextButton(
                        back: () => AppPages.router.go(AppPath.DEFAULTCONSTRUCTOR),
                        next: () => AppPages.router.go(AppPath.NAMEDCONSTRUCTOR),
                        isEnableBack: true,
                        isEnableNext: true,
                      ),
          ...
          GetBuilder<ParameterizedConstructorController>(builder: (_) => controller.showBackToTopButton ? Positioned(bottom: 20, right: 20, child: FloatingActionButton(backgroundColor: AppColors.primary700, onPressed: controller.scrollToTop, child: const Icon(Icons.arrow_upward, color: Colors.white))) : const SizedBox.shrink()),
        ],
      ),
    );
  }
