...
class FunctionsPage extends GetView<FunctionsController> {
            ...
            slivers: [
              if (!AS.deviceScreenType.isMobile)
                SliverAppBar(
                  ...
                  floating: false,
                  pinned: true,
                  flexibleSpace: PageHeader(headerName: SK.functions),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const CommonHeight(height: 20),
                      BigText(
                        text: controller.returnTypesTitle,
                        style: AppStyle.globalBigTextStyle.copyWith(
                          fontSize: 22,
                          fontWeight: FontWeight.bold,
                        ),
                      ...
                      const CommonHeight(height: 8),
                      BigText(
                        text: controller.returnTypesDesc,
                        style: AppStyle.globalSmallTextStyle.copyWith(
                          fontSize: 16,
                          fontWeight: FontWeight.normal,
                        ),
                      ...
                      const CommonHeight(height: 8),
                      CodeWidget(code: controller.returnTypesCode),
                      const CommonHeight(height: 8),
                      CodeWidget(
                          code: controller.returnTypesOutput),
                      const CommonHeight(height: 20),
                      BigText(
                        text: 'Tips',
                        style: AppStyle.globalBigTextStyle.copyWith(
