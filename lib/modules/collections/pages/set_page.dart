...
class SetPage extends GetView<SetController> {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
            ...
            slivers: [
              if (!AS.deviceScreenType.isMobile)
                SliverAppBar(
                  ...
                  floating: false,
                  pinned: true,
                  flexibleSpace: PageHeader(headerName: SK.setInDart),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const CommonHeight(height: 20),
                      BigText(text: controller.creatingSetTitle, style: AppStyle.globalBigTextStyle.copyWith(fontSize: 22, fontWeight: FontWeight.bold)),
                      const CommonHeight(height: 8),
                      BigText(text: controller.creatingSetDesc, style: AppStyle.globalSmallTextStyle.copyWith(fontSize: 16, fontWeight: FontWeight.normal)),
                      const CommonHeight(height: 8),
                      CodeWidget(code: controller.creatingSetCode),
                      const CommonHeight(height: 8),
                      CodeWidget(code: controller.creatingSetOutput),
                      const CommonHeight(height: 20),
                      BigText(text: controller.setOpsTitle, style: AppStyle.globalBigTextStyle.copyWith(fontSize: 22, fontWeight: FontWeight.bold)),
                      const CommonHeight(height: 8),
                      BigText(text: controller.setOpsDesc, style: AppStyle.globalSmallTextStyle.copyWith(fontSize: 16, fontWeight: FontWeight.normal)),
                      const CommonHeight(height: 8),
                      CodeWidget(code: controller.setOpsCode),
                      const CommonHeight(height: 8),
                      CodeWidget(code: controller.setOpsOutput),
                      const CommonHeight(height: 20),
                      ...
                      PreviousNextButton(
                        back: () => AppPages.router.go(AppPath.LISTINDART),
                        next: () => AppPages.router.go(AppPath.MAPINDART),
                        isEnableBack: true,
                        isEnableNext: true,
                      ),
          ...
          GetBuilder<SetController>(builder: (_) => controller.showBackToTopButton ? Positioned(bottom: 20, right: 20, child: FloatingActionButton(backgroundColor: AppColors.primary700, onPressed: controller.scrollToTop, child: const Icon(Icons.arrow_upward, color: Colors.white))) : const SizedBox.shrink()),
        ],
      ),
    );
  }
