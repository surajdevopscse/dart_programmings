...
import '../controllers/flutter_qa_controller.dart';

class FlutterQAPage extends GetView<FlutterQAController> {
  const FlutterQAPage({super.key});
            ...
            slivers: [
              if (!AS.deviceScreenType.isMobile)
                SliverAppBar(
                  ...
                  floating: false,
                  pinned: true,
                  flexibleSpace: PageHeader(headerName: 'Flutter Interview Q&A'),
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            BookmarkIconBtn(routePath: '/interview-prep/flutter-interview-qa', pageTitle: 'Flutter Interview Q&A'),
                          ],
                        ),
                        const CommonHeight(height: 8),
                        SmallText(
                          text: 'Master Flutter with these commonly asked interview questions covering widgets, state management, navigation, animations, and more.',
                        ),
