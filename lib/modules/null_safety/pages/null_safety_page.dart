...
import '../controllers/null_safety_controller.dart';

class NullSafetyPage extends GetView<NullSafetyController> {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
            ...
            slivers: [
              if (!AS.deviceScreenType.isMobile)
                SliverAppBar(
                  ...
                  floating: false,
                  pinned: true,
                  flexibleSpace: PageHeader(headerName: SK.nullSafety),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      PreviousNextButton(
                        back: () => AppPages.router.go(AppPath.FACTORYCONSTRUCTOR),
                        next: () => AppPages.router.go(AppPath.TYPEPROMOTIONS),
                        isEnableBack: false,
                        isEnableNext: true,
                      ),
          ...
          GetBuilder<NullSafetyController>(builder: (_) => controller.showBackToTopButton ? Positioned(bottom: 20, right: 20, child: FloatingActionButton(backgroundColor: AppColors.primary700, onPressed: controller.scrollToTop, child: const Icon(Icons.arrow_upward, color: Colors.white))) : const SizedBox.shrink()),
        ],
      ),
    );
  }
